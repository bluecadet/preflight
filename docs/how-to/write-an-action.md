...
- The embedded stdlib in this repo includes leaf actions such as `preflight/autologin`, plus grouped Windows actions such as `preflight/windows-machine` and `preflight/windows-power`.
